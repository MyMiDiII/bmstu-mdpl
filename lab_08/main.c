...
int main(void)
{
    ...
    printf("SRC: %s\n", test2_string);
    printf("LEN: %lu\n", asmblen);
    astrcpy(buffer, test2_string, asmblen);
    printf("DST: %s\n", buffer);
    ...
    printf("SRC: %s\n", test2_string);
    printf("LEN: %lu\n", 4LU);
    astrcpy(buffer2, test2_string, 4);
    printf("OUT: %s\n", buffer2);
    ...
    printf("SRC: %s\n", test2_string);
    printf("LEN: %lu\n", asmblen);
    astrcpy(test2_string, test2_string, asmblen);
    printf("OUT: %s\n", test2_string);
    ...
    printf("SRC: %s\n", test2_string);
    printf("LEN: %lu\n", asmblen / 2);
    astrcpy(test2_string, test2_string + asmblen / 2, asmblen / 2);
    printf("OUT: %s\n", test2_string);
    ...
    printf("SRC: %s\n", test2_copy);
    printf("LEN: %lu\n", asmblen);
    astrcpy(test2_copy + asmblen / 2, test2_copy, asmblen);
    ...
    printf("SRC: %s\n", test2_copy2);
    printf("LEN: %lu\n", asmblen);
    astrcpy(test2_copy2 + asmblen, test2_copy2, asmblen);
    printf("OUT: %s\n", test2_copy2 + asmblen);
